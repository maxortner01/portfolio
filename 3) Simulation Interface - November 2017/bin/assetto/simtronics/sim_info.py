...
def demo():
    return {'speed': info.physics.speedKmh, 'tyreCompound': info.graphics.tyreCompound, 'currentTime': info.graphics.currentTime,
           'rpms': info.physics.rpms, 'maxRpm': info.static.maxRpm, 'tyreWear': list(info.physics.tyreWear), 
		   'gear': info.physics.gear, 'throttle': info.physics.gas, 'brake': info.physics.brake, 'maxFuel': info.static.maxFuel,
		   'fuel': info.physics.fuel, 'pitch': info.physics.pitch, 'roll': info.physics.roll}
        #time.sleep(0.1)
